...
Source0  : https://cran.r-project.org/src/contrib/raster_3.3-7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593469879
...
/usr/lib64/R/library/raster/tests/testthat/test-getvaluesblock.R
