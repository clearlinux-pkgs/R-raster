...
Version  : 3.0.12
Release  : 31
URL      : https://cran.r-project.org/src/contrib/raster_3.0-12.tar.gz
Source0  : https://cran.r-project.org/src/contrib/raster_3.0-12.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580409306
