...
Version  : 3.6.32
Release  : 76
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/raster_3.6-32.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/raster_3.6-32.tar.gz
...
%setup -q -n raster
pushd ..
cp -a raster buildavx2
popd
pushd ..
cp -a raster buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745274159
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/raster/libs/raster.so
/V4/usr/lib64/R/library/raster/libs/raster.so
