...
Version  : 2.9.23
Release  : 25
URL      : https://cran.r-project.org/src/contrib/raster_2.9-23.tar.gz
Source0  : https://cran.r-project.org/src/contrib/raster_2.9-23.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562876237
