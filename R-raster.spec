...
Version  : 2.6.7
Release  : 4
URL      : https://cran.r-project.org/src/contrib/raster_2.6-7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/raster_2.6-7.tar.gz
Summary  : Geographic Data Analysis and Modeling
Group    : Development/Tools
License  : GPL-3.0
Requires: R-raster-lib
Requires: R-Rcpp
Requires: R-sp
...
export LANG=C
export SOURCE_DATE_EPOCH=1521169215
...
/usr/lib64/R/library/raster/external/countries.csv
