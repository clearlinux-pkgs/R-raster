...
Version  : 3.1.5
Release  : 33
URL      : https://cran.r-project.org/src/contrib/raster_3.1-5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/raster_3.1-5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587404437
