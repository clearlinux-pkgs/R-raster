...
Version  : 3.3.13
Release  : 37
URL      : https://cran.r-project.org/src/contrib/raster_3.3-13.tar.gz
Source0  : https://cran.r-project.org/src/contrib/raster_3.3-13.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594999004
...
/usr/lib64/R/library/raster/tests/test_getvaluesblock.R
/usr/lib64/R/library/raster/tests/test_rasterize.R
/usr/lib64/R/library/raster/tests/test_sf-coercion.R
/usr/lib64/R/library/raster/tests/test_subset.R
